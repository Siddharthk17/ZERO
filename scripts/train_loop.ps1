param(
    ...
    [int] $GateBatchSize = 8,
    [int] $GateWorkers = 0,
    [double] $GateMinScore = 0.50,
    [double] $GateLowerBound = 0.45,
...
while ($true) {
    ...
    $arguments += @(
        ...
        "--fast-search-weight", $FastSearchWeight,
        ...
        "--gate-workers", $GateWorkers,
        "--gate-min-score", $GateMinScore,
        "--gate-lower-bound", $GateLowerBound,
